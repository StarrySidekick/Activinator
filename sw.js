...
const CACHE = 'activinator-v31';
const SHELL = [
  './', './index.html',
  './css/base.css', './css/deck.css', './css/panels.css', './css/table.css',
  './js/boot.js', './js/state.js', './js/data.js', './js/vocab.js', './js/activities.js', './js/taste.js',
  './js/deal.js', './js/cards.js', './js/panels.js', './js/table.js',
  './js/hour.js', './js/toast.js',
